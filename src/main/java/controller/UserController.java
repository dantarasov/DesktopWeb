...
import com.example.prototype.service.SecurityService;
import com.example.prototype.service.UserService;
import com.example.prototype.validator.UserValidator;
...
public class UserController {
    ...
    public String login (Model model, String error, String logout){
        ...
        if(logout!=null){
            model.addAttribute("message" , "Logged out seccessfuly.");
